...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Page.ClientScript.RegisterClientScriptInclude("jquery-1.6.2.min.js", Me.TemplateSourceDirectory & "/js/jquery-1.6.2.min.js")
        Me.Page.ClientScript.RegisterClientScriptInclude("jquery-ui-1.8.16.custom.min.jss", Me.TemplateSourceDirectory & "/js/jquery-ui-1.8.16.custom.min.js")
        Me.Page.ClientScript.RegisterClientScriptInclude("System.js", Me.TemplateSourceDirectory & "/js/System.js")
        Me.Page.ClientScript.RegisterClientScriptInclude("ext-debug.js", Me.TemplateSourceDirectory & "/js/ext-debug.js")
        Me.Page.Header.Controls.Add(New LiteralControl("<link type='text/css' href='" & Me.TemplateSourceDirectory & "/css/start/jquery-ui-1.8.16.custom.css' rel='stylesheet' />"))
        Me.Page.Header.Controls.Add(New LiteralControl("<link type='text/css' href='" & Me.TemplateSourceDirectory & "/css/ext-all.css' rel='stylesheet' />"))
...
<dnn:ARTMENU ID="ArtMenu1" ShowHiddenTabs="False" ShowAdminTabs="True" ShowDeletedTabs="False" ShowLoginTab="True" ShowUserTab="False" runat="server" /><div id="TopPane" visible="false" runat="server"></div>
