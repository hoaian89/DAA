...
<div class="art-logo">
 <h1 id="name-text" class="art-logo-name"><a href="<%= DotNetNuke.Common.Globals.NavigateURL(Me.PortalSettings.HomeTabId) %>">Trường ĐH Công Nghệ Thông Tin</a></h1>
 <div id="slogan-text" class="art-logo-text">Phòng Đào Tạo Đại Học &amp; Sau Đại Học</div>
</div>
