                            ...
                            <div class="logo_pad">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="350">
                                            <div runat="server" id="TopLeftPanel"  ></div>
                                        </td>
                                        <td>
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        <div class="search_style">
                                                            <div class="search_bg">
                                                                <dnn:SEARCH runat="server" id="Object1"  CssClass="ServerSkinWidget" UseDropDownList="true" Submit="<img src=&quot;images/search.gif&quot; border=&quot;0&quot; alt=&quot;Search&quot; /&gt;" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                        <div runat="server" id="TopRightPanel"  ></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
