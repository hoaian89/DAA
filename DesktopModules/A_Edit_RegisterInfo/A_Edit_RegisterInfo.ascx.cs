...
public partial class DesktopModules_A_Edit_RegisterInfo_A_Edit_RegisterInfo : PortalModuleBase
{
    ...
    protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        source.UpdateParameters["SubID"].DefaultValue = ClassID.Substring(0, ClassID.LastIndexOf(".") );
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string ClassID = ((TextBox)GridView2.FooterRow.FindControl("ClassidFooter")).Text;
	...
	ShowInfo.Text = ClassID.Substring(0, ClassID.LastIndexOf("."));
            using (SqlConnection scon = new SqlConnection(source.ConnectionString))
            {
                scon.Open();
                int i = 0;
