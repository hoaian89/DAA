...
<%@ Register Assembly="FreeLibrary" Namespace="FreeLibrary" TagPrefix="cc1" %>
...
<asp:SqlDataSource ID="AnnounmentList" runat="server" 
    ...
    SelectCommand="SELECT top 15 [Title], [ItemID] FROM [Announcements] WHERE [ModuleID] = @ModuleID
...
<asp:TextBox ID="Title" runat="server" Font-Bold="True" Width="78%"></asp:TextBox>
<strong> - </strong>
    <asp:DropDownList ID="TargetDrop" runat="server" Width="12%">
        <asp:ListItem Text="ĐH Chính qui" Selected="True" Value="0"></asp:ListItem>
        <asp:ListItem Text="Cao học" Value="1"></asp:ListItem>
        <asp:ListItem Text="ĐT từ xa" Value="2"></asp:ListItem>
    </asp:DropDownList>
<br />
<dnn:TextEditor ID="teContent" runat="server" Width="100%" Height="500" 
    ...
    <hr />
    <div>
        <b style="color: #CC3300">** Đính kèm file : </b> <br/> 
        <cc1:NewRowGridView ID="myNewRowGridView" runat="server" AutoGenerateColumns="False"
            DataSourceID="myDataSource" NewRowCount="2" Width="220px">
            <Columns>
                <asp:TemplateField  HeaderText="     files">
                    <itemtemplate >
                        &nbsp;<asp:TextBox id="TextBox1" Width="95%" runat="server" Text='<%# Bind("Name") %>' __designer:wfdid="w11" >
                        </asp:TextBox>
                    </itemtemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Chọn">
                    <itemtemplate>
                        <asp:CheckBox runat="server" Checked="true" id ="check"/>
                    </itemtemplate>
                </asp:TemplateField >
            </Columns>
        </cc1:NewRowGridView>
        ...
        <asp:ObjectDataSource ID="myDataSource" runat="server" SelectMethod="GetMyObjects"
            TypeName="MyObjects">
        </asp:ObjectDataSource>
        <asp:FileUpload ID="FileUpload1" runat="server" />
        &nbsp; <asp:LinkButton ID="LinkButton1A" runat="server" onclick="Button1_Click">Upload</asp:LinkButton>
        &nbsp; / &nbsp; <asp:LinkButton ID="LinkButton2A" runat="server" onclick="Button2_Click">Xóa hết</asp:LinkButton>
    </div>
    <hr />
    <table class="style3">
        <tr>
...
<Triggers>
        <asp:PostBackTrigger ControlID="LinkButton1A" />
    </Triggers>
</asp:UpdatePanel>
